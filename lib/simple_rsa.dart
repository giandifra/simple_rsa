...
const MethodChannel _channel = const MethodChannel('juanito21.com/simple_rsa');
...
Future<List<int>> decryptStringWithPublicKey(
  ...
  try {
    publicKey = publicKey
        ...
        .replaceAll("-----BEGIN PUBLIC KEY-----", "")
        .replaceAll("-----END PUBLIC KEY-----", "");
    final List<int> result = await _channel.invokeMethod(
